...
function Data() {
  return (
    <div className="home__data">
        <h1 className="home__title">Shams Haroon 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a computer science student and software engineer based in Toronto, Canada, with experience in developing full stack software applications.</p>
